...
<CardGroup cols={3}>
  ...
  <Card title="Plivo" href="/integrations/telephony/plivo">
    Developer-friendly voice APIs with competitive India pricing
  </Card>
  <Card title="Vobiz" href="/integrations/telephony/vobiz">
    Cloud-based telephony with global reach and flexible routing
  </Card>
  <Card title="Cloudonix" href="/integrations/telephony/cloudonix">
    SIP-first telephony connectivity for cloud and on-prem systems
  </Card>
  <Card title="Asterisk ARI" href="/integrations/telephony/asterisk-ari">
    Integrate with your own Asterisk PBX using ARI
  </Card>
...
2. Select your provider (Twilio, Vonage, Plivo, Vobiz, Cloudonix, or Asterisk ARI)
...
- **Plivo**: ✅ Implemented for outbound and inbound workflows
- **Vobiz**: ✅ Implemented with inbound and outbound support
- **Cloudonix**: ✅ Implemented with SIP-centric routing support
- **Asterisk ARI**: ✅ Implemented for PBX-based deployments
...
- [Set up Plivo integration](/integrations/telephony/plivo)
