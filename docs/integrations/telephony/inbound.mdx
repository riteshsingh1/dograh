...
description: "Configure inbound calling for Twilio, Plivo, Vobiz, Cloudonix, and Asterisk ARI providers in Dograh AI"
---
...
<CardGroup cols={3}>
  ...
  <Card title="Plivo" href="/integrations/telephony/plivo">
    Programmable voice APIs with inbound support and webhook-based routing
  </Card>
